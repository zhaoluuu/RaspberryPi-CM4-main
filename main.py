...
#lcd_draw_string(draw, 210, 133, firmware_info, color=color_white, scale=font1)#这是显示xgolite的
lcd_draw_string(draw, 140, 133, "DOGZILLA-Lite", color=color_white, scale=font1)#改成yahboom的显示
lcd_draw_string(draw, 180, 153, "CM4", color=color_white, scale=font1)#改成yahboom的显示
